...
if(isset($_POST['change_pass'])){
	...
	$customer_id=$_SESSION['Customer_Id'];
		...
		$sql="SELECT Password from registration WHERE Customer_ID='$customer_id' ";
	...
	if($row['Password'] == $oldpass ){
		...
		$sql2="UPDATE registration SET  password='$newpass' WHERE registration.Customer_ID=$customer_id ";
		$conn->query($sql2);
